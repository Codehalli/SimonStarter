...
//This configure the PWM for a note
void ConfigurePWM(Timer_A_PWMConfig *pwmConfig_p, basic_note_t note) {
    ...
    pwmConfig_p->compareOutputMode =  TIMER_A_OUTPUTMODE_TOGGLE_SET;
    ...
    pwmConfig_p->timerPeriod = 10000* pwmConfig_p->clockSourceDivider  / toneFreq[note];
    ...
    pwmConfig_p->dutyCycle   = pwmConfig_p->timerPeriod*.9;
